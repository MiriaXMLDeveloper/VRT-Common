...
&trade;</span></font></i></b>
  ...
  <tr>
    ...
    <br><br><br>
This is an e-mail confirmation that your pre-paid card ${document.processCode} has been sent to you. Please contact corpcard@cabelas.com to confirm receipt of the card. <br>
The card will have a zero balance until you confirm receipt.</font>
