...
<table width="100%" bgcolor="#FFFFFF">
				...
				<tr><td><font size="2" face="Verdana"><b>Vendor Name : </b></font></td><td><font size="2" face="Verdana"><#if document.scanVendorName?exists>${document.scanVendorName}<#else>${""}</#if></font></td></tr>
				...
				<tr><td><font size="2" face="Verdana"><b>Gross Amount : </b></font></td><td><font size="2" face="Verdana"><#if document.grossAmount?exists>${document.grossAmount?string(",##0.00")}<#else>${""}</#if></font></td></tr>
				...
				<tr><td><font size="2" face="Verdana"><b>Amount : </b></font></td><td><font size="2" face="Verdana"><#if docline.lineTotal?exists>${docline.lineTotal?string(",##0.00")}<#else>${""}</#if></font></td></tr>
