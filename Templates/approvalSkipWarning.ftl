...
&trade;</span></font></i></b>
  ...
  <tr>
    ...
    <b>Invoice Approval Skip Warning</b><br>
    <br>
    Dear ${user.displayName}:<br>
    <br>
Please be aware that this invoice will be escalated to your manager for approval if it is not acted upon within the next 24 hours.</font>
