...
&trade;</span></font></i></b>
  ...
  <tr>
    ...
    <b>GL Distribution Change Notification</b><br>
    <br>
    Dear ${user.displayName}:<br>
    <br>
Please be aware that the subsequent approver has edited either the ledger codes or amounts on line items previously entered by you.</font>
...
here</a> to view the invoice.</font><br>
					<table>
						...
						<tr>
							<td width="50%"><b><font size="2" face="Verdana">Group:</b></font></td>
