...
&trade;</span></font></i></b>
  ...
  <tr>
    ...
    <b>Draft Report Notification</b><br>
    <br>
    Dear ${user.displayName}:<br>
    <br>
An expense report has been saved to your ActiveOps inbox. When ready, please complete the report and submit it for approval. Remember to also upload your receipts.</font>
